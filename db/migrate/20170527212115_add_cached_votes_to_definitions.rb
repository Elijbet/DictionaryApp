class AddCachedVotesToDefinitions < ActiveRecord::Migration[5.1]
  def self.up
    ...
    add_column :definitions, :cached_weighted_score, :integer, :default => 0
    add_column :definitions, :cached_weighted_total, :integer, :default => 0
    add_column :definitions, :cached_weighted_average, :float, :default => 0.0
    ...
    add_index  :definitions, :cached_weighted_score
    add_index  :definitions, :cached_weighted_total
    add_index  :definitions, :cached_weighted_average
  ...
  def self.down
    ...
    remove_column :definitions, :cached_weighted_score
    remove_column :definitions, :cached_weighted_total
    remove_column :definitions, :cached_weighted_average
  end
end
